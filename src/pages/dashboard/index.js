...
//     (async () => {
//       try {
//         checkDatesValid(startDate, endDate); //checks the validity
...
//           //////////////////////////////////////////////////////>?????????????????????????????????????????????????///////
//           console.log("Dashboard Response", response); // Add this line for inspection
//           //////////////////////////////////////////////////////>?????????????????????????????????????????????????/////////
//           setDashboardData(response.data); //sets the response data in the dashboardData state using setDashboardData
//         }
...
//   /* Accepts several props, including data for bar charts, pie charts, status counts,etc*/
//   barData,
//   pieStats,
//   statusCount,
//   totalContainers,
...
// }) => {
//   //Transforms pieStats into a format suitable for PieChart
...
//   );
// };
// //Displays a centered CircularProgress component indicating a loading state
...
//commented version:
// This file contains the main Dashboard component and helper functions for date validation and API data fetching.
